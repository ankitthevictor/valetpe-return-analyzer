...
export default function Home() {
  ...
  const analyze = async () => {
    ...
    if (!url.trim()) {
      setError("Please paste a product or website URL.");
      return;
    }
      ...
      <div className="container">
        <div className="card">
          ...
          <p className="card-subtitle">
            Paste any product link. Get a clean summary + risk score + India comparison.
          </p>
            ...
            <div className="result-wrapper">
              <div className="result-card" ref={cardRef}>
                <div className="result-row">
                  ...
                  &nbsp;&nbsp; <span className="result-label">Category:</span> {data.category}
                </div>

                <div className="result-row" style={{ marginTop: 6 }}>
                  <span className="result-label">Return Window:</span> {data.returnWindow}
                  &nbsp;&nbsp;<span className="result-label">Refund:</span> {data.refundType}
                </div>

                <div className="result-row" style={{ marginTop: 6 }}>
                  <span className="result-label">Method:</span> {data.returnMethod}
                ...
                <div>
                  ...
                  <p style={{ fontSize: "0.85rem", marginTop: 4 }}>{data.benchmark}</p>
                  <p style={{ fontSize: "0.8rem", color: "#9ca3af" }}>Tip: {data.tip}</p>
                </div>
              </div>
